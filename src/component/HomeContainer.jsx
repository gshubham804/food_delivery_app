...
const HomeContainer = () => {
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id="home">
     <div className='py-2 flex-1 flex flex-col items-start gap-5'>
...
<p className='leading-tight text-[2.5rem] lg:text-[4.5rem] font-bold tracking-wide text-headingColor'>
...
<p className='text-base text-textColor text-justify md:text-left md:w-[80%]'>
 Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti quidem fuga, perferendis quia quo obcaecati maxime minima nam, sint, nisi fugiat deserunt reiciendis architecto perspiciatis in quisquam a laudantium similique.
</p>
...
<button type='button' className='bg-gradient-to-br from-orange-400 to-orange-500 w-full md:w-auto px-4 py-2 rounded-lg hover:shadow-lg transition-all ease-in-out duration-100'>Order Now</button>
     ...
     <div className='py-2 flex-1 flex items-center relative'>
        ...
        <div className='w-full h-full absolute top-0 left-0 flex items-center justify-center lg:pr-32 py-4 gap-4 flex-wrap'>
